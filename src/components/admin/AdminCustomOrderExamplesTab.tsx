...
export function AdminCustomOrderExamplesTab() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      {isLoading ? (
        <div className="mt-6 text-sm text-gray-500">Loading examples...</div>
      ) : (
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {slots.map((slot, idx) => (
            <div key={slot.id} className="rounded-lg border border-gray-200 p-3 space-y-3">
              <div className="relative aspect-[4/5] bg-gray-100 rounded-lg overflow-hidden flex items-center justify-center">
                {slot.imageUrl ? (
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-md border border-gray-300 px-3 py-1.5 text-xs font-medium text-gray-700 hover:border-gray-400"
                >
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-600 uppercase mb-1">Tags</label>
                <input
                  type="text"
                  value={slot.tags}
